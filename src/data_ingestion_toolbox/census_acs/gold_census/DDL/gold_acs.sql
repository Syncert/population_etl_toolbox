...
-- tuples: `BETA_RESET_REINGESTION.md` §7 recorded this table at 37 GB of heap and 25 GB of indexes, and its operator
...
ALTER TABLE gold_census.rpt_acs_observations SET (
