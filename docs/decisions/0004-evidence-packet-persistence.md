...
- **Related work:** implemented by the [evidence packet persistence plan](../plans/needs_review/EVIDENCE_PACKET_PERSISTENCE_PLAN.md); unblocks WEB-007 in the [web analytics first-wave plan](../plans/needs_review/WEB_ANALYTICS_FIRST_WAVE_PLAN.md); extends [ADR-0003](0003-saved-analysis-authentication-and-persistence.md)
