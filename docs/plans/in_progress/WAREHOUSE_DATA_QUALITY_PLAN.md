...
- **Next pickup:** Execute DQ-005 (independent `warehouse_data_quality` DAG with source/rule/partition targeting and queryable summaries), then DQ-006 (plausibility baselines and warning review lifecycle) and DQ-007 (CI wiring and release certification).
