...
- **Next pickup:** Execute DQ-003: lineage and layer reconciliation executors (raw checksum/request reconciliation, capture-to-silver identity reconciliation, silver-to-gold publication reconciliation) with publication gating on blocking rules.
- **Completed evidence:**
