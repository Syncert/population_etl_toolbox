...
- **Status:** Accepted 2026-09-14 (Ready for review. Claimed and delivered 2026-09-12. The element door is closed in the build that ships; the attribute door is open on a recorded list of owners, each of which was measured rather than assumed.)
