...
- **Status:** Accepted 2026-09-14 (Ready for review. Authored, claimed, and delivered 2026-09-13 from an investigation of what a saved configuration can and cannot express.)
...
is filed as `docs/plans/completed/EXPLORER_SAVED_REDUCTION_PLAN.md`.
