...
- **Status:** Accepted 2026-09-14 (Ready for review. Claimed and delivered 2026-09-12. Opened from the live-stack smoke tier (WEB-027), which found 13 catalog metrics answering no row through the explorer's own access shape; chasing that down found a repo-wide contract defect rather than a stack-state one.)
