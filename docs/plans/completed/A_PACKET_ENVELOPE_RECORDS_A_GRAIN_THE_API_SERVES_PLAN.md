...
- **Status:** Accepted 2026-09-14 (Needs review. Investigated, authored and implemented 2026-09-13. **The third and last surface in the closed-grain family: API-122 closed the request, API-123 the stored query, this the stored envelope.**)
