...
- **Status:** Accepted 2026-09-14 (Implemented; awaiting review. Authored 2026-09-13 by the assessment agent; claimed and completed 2026-09-13. It was a present defect: the `frontend` job was flaky on this branch because of it. Register row **WEB-068** (WEB-062, suggested at authoring time, had been taken).)
