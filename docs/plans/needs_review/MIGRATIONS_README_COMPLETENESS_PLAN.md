...
- **Status:** Ready for review. Claimed and delivered 2026-09-12. The README
  describes `001`–`018`, one entry per file with the ordinal the file carries,
  and DB-029 fails when the manifest and the document disagree in either
  direction.
