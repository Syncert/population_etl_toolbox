...
- **Status:** Ready for review. Claimed and delivered 2026-09-12.
  `frontend-smoke` is the fourteenth required job in the register and its
  executable mirror, and deleting the workflow or renaming its job now fails a
  test.
