...
| Publisher-contract changes reaching the catalog (ARC-004) | ride `etl-unit` and `postgres-integration` above | Required PR/push | `src/data_ingestion_toolbox/glossary/harvest.py`, `dags/glossary_harvest_dag.py`, `sql/migrations/015_publisher_harvest_fingerprint.sql`, `tests/unit/shared/test_glossary_harvest_guard.py`, `tests/integration/database/test_glossary_harvest_identity_change.py` |
