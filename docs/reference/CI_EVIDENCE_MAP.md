...
| Live provider compatibility | `external-contract` / `Census, BLS, and FRED live contracts` | Scheduled/manual; fresh within 7 days for release | source adapters and provider fixtures |
