"""Manual Wisconsin Census ingestion diagnostic."""

from data_ingestion_toolbox.census_acs.ingest import ingest_slice
...
def run_for(dataset: str):
    ...
    rows_wi_state = ingest_slice(
        year=year, dataset=dataset, geo_level="state", state_fips="55"
    )
