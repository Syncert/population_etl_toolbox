...
def update_env_file(path: Path, updates: dict[str, str]) -> None:
    ...
    if remaining:
        if output and output[-1]:
            output.append("")
        output.append("# Read-only public serving role (generated by provision_api_readonly.py).")
...
def main() -> int:
    ...
    role_password = value(values, "ANALYTICS_API_DB_PASSWORD") or secrets.token_urlsafe(32)
    ...
    if args.write_env:
        ...
        print("Re-run with --write-env to store generated serving credentials in the env file.")
    return 0
