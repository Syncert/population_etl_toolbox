...
3. `003_semantic_policy_extraction.sql` removes authored policy from the shared metric contract. Apply this only after the remaining report/API consumers have been cut over; it is intentionally not in the test bootstrap yet.
