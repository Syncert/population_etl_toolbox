...
def get_bls_latest_observations(
    ...
    """Return latest BLS observations from the gold_bls schema."""
...
def get_bls_timeseries_observations(
    geo_id: str,
    metric_code: Optional[str] = None,
    metric_id: Optional[str] = None,
    ...
    """Return BLS time-series observations from the gold_bls schema."""
