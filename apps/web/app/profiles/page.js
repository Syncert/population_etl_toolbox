  ...
  return (
    <main className="page-shell compact-page">
      ...
      <section className="profile-controls">
        ...
        <Link className="button secondary" href={`/explore?metric=${encodeURIComponent(populationMetric)}&geo=${encodeURIComponent(geoId)}&state=${stateFips}`}>Open in Explorer <ArrowRight size={15} /></Link>
      </section>
